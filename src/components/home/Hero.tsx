...
const badges = ["Local Karnali Experts", "WhatsApp Booking", "Safe Vehicles", "Custom Itineraries"];

export function Hero() {
  return (
    <section className="relative min-h-[calc(100vh-5rem)] overflow-hidden">
      <Image src="/images/karnali-hero.png" alt="Karnali mountain lake travel landscape" fill priority className="object-cover" />
      ...
      <div className="container-main relative flex min-h-[calc(100vh-5rem)] items-center px-5 py-20 sm:px-8 lg:px-10">
        <div className="max-w-3xl text-white">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-white/82">
            Tours, trekking, Rara Lake trips, Phoksundo adventures, and vehicle rental from Surkhet with practical local travel support.
          </p>
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <a href={getWhatsAppUrl()} target="_blank" rel="noreferrer" className="btn-secondary">WhatsApp Now</a>
          </div>
